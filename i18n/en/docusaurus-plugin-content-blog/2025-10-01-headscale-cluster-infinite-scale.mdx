...
description: "How to evolve Headscale from a monolith into a scalable cluster with cluster_id sharding, shared PostgreSQL, ACS, and incremental netmap rebuilds."
authors: [ownding]
